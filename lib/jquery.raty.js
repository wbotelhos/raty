...
;(function($) {
  ...
  var methods = {
    ...
    _getScoreByPosition: function(evt, icon) {
      ...
      if (this.opt.half) {
        var percent = parseFloat((evt.pageX - star.offset().left) / this.opt.size);
    ...
    destroy: function() {
      return this.each(function() {
        ...
        if (raw) {
          self.off('.raty').empty().css({ cursor: raw.style.cursor, width: raw.style.width }).removeData('readonly');
        } else {
