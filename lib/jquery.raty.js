  ...
  $.raty.Raty = (function() {
    ...
    Raty.prototype = {
      ...
      _bindClickCancel: function() {
        this.cancel.on('click.raty', function(evt) {
      ...
      _bindOut: function() {
        this.self.on('mouseleave.raty', function(evt) {
          var score = +this.score.val() || undefined;
      ...
      _bindOutCancel: function() {
        ...
        this.cancel.on('mouseleave.raty', function(evt) {
      ...
      _bindOverCancel: function() {
        ...
        this.cancel.on('mouseover.raty', function(evt) {
          if (that.self.data('readonly')) {
            return;
          }
      ...
      fnCancel: function(click) {
        if (this.self.data('readonly') !== true) {
          this[click ? 'click' : 'fnScore'].call(this, null);
