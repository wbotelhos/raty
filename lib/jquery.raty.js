  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        methods._initialize.call(this, inits);
      ...
      if (this.opt.score) {
        score.val(this.opt.score);
        methods._adjustStars.call(this, this.opt.score);
      }
    ...
    }, _initialize: function(options, block) {
      for (i in options) {
      ...
      if (score > 0) {
        if (this.opt.halfShow) {
          methods._adjustStars.call(this, score);
        }
