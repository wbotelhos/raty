...
(function(root, factory) {
  ...
  var methods = {
    ...
    _bindTouch: function() {
      ...
      that.stars.on('touchmove.raty touchend.raty', function(evt) {
        var touchEvent = evt.originalEvent.changedTouches[0];

        ['mousemove', 'click'].map(function(type){
