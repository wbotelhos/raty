    ...
    Raty.prototype = {
      ...
      _adjustCallback: function() {
        ...
        for (var i = 0; i < options.length; i++) {
          if (typeof this.opt[options[i]] === 'function') {
            this.opt[options[i]] = this.opt[options[i]]();
          }
        }
      },
      ...
      _bindClickCancel: function() {
        ...
        that.cancel.on('click.raty', function(evt) {
          ...
          if (that.opt.click) {
            that.opt.click.call(that.element, null, evt);
          }
        });
      },
      ...
      _createScore: function() {
        ...
        this.score = score.length ? score : this._buildScoreField();
      },
      ...
      _getHint: function(score, evt) {
        ...
        var decimal = this._getFirstDecimal(score);
      ...
      _lock: function() {
        var hint = this._getHint(this.score.val());
      ...
      fnCancel: function(click) {
        var self = $(this);

        if (self.data('readonly') !== true) {
          this[click ? 'click' : 'fnScore'](null);
      ...
      fnScore: function() {
        ...
        return arguments.length ? this.setScore.apply(self, arguments) : this.getScore.call(self);
      },
      ...
      setScore: function(score) {
        if ($(this).data('readonly') !== true) {
          score = this[0]._adjustedScore(score);

          this[0]._apply(score);
          this[0]._target(score);
        }
      }
    };
