    ...
    _createStars: function() {
      ...
      for (var i = 1; i <= this.opt.number; i++) {
        ...
        if (this.opt.starType === 'img'){
          star.attr({ src : icon, alt: i, title: title }).appendTo(this);
        } else {
          icon = icon.replace(this.opt.path, '');
          star.attr({ class : icon, 'data-alt': i, title: title }).appendTo(this);
        }
