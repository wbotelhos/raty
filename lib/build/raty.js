...
var defaultoptions = Object.seal({
  cancelButton: false,
...
var Raty = function () {
  function Raty(element, options) {
    ...
    if (options) {
      if (_typeof(options) === 'object') {
        this.opt = _objectSpread(_objectSpread({}, defaultoptions), options);
      } else {
  ...
  _createClass(Raty, [{
    ...
    value: function cancel(click) {
      if (typeof this.self.dataset.readOnly === "string" && !this.self.dataset.readOnly.toBoolean()) {
    ...
    value: function readOnly(readonly) {
      if (typeof this.self.dataset.readOnly === "string" && this.self.dataset.readOnly.toBoolean() !== readonly) {
        if (readonly) {
          this._lock();
        } else {
          this._binds();
    ...
    value: function _bindClick() {
      ...
      this.stars.forEach(function (value) {
        value.addEventListener('click', function (evt) {
          if (that.self.dataset.readOnly && that.self.dataset.readOnly.toBoolean()) {
            return;
          }
    ...
    value: function _createScore() {
      ...
      this.scoreField = score !== null && score !== void 0 ? score : this._buildScoreField();
    }
  }, {
    key: "_createStars",
    value: function _createStars() {
      for (var i = 1; i <= this.opt.number; i++) {
        ...
        var element = document.createElement(this.opt.starType);
        var el = this.opt.starType === 'img' ? img : element;
        el.id = 'raty-rate-' + i;
      ...
      var stars = document.querySelectorAll("".concat(this.element, " > ").concat(this.opt.starType, "[id^=\"raty-rate\"]"));

      if (this.cancelButton) {
        stars.filter(function (value) {
          return value.id !== '#raty-cancel-btn';
        });
      }
    ...
    value: function _getWidth() {
      var width = this.stars[0].width || parseFloat(this.stars[0].offsetWidth);
    ...
    value: function _lock() {
      var _this$scoreField;

      var hint = this._getHint(this === null || this === void 0 ? void 0 : (_this$scoreField = this.scoreField) === null || _this$scoreField === void 0 ? void 0 : _this$scoreField.value);
